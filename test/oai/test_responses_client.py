...
def test_message_retrieval_with_real_response_structure():
        ...
        def model_dump(self):
            return {
                ...
                "content": [
                    {
                        "annotations": [],
                        "text": "New York City: where 'rush hour' lasts all day and finding parking is a sport.\nTERMINATE",
                        "type": "output_text",
                        "logprobs": [],
                    }
                ],
    ...
    # Create response with reasoning item (should be skipped) and message
    output = [MockReasoningItem(), MockOutputMessage()]
    resp = _FakeResponse(output=output)
    ...
    assert (
        text_item["text"] == "New York City: where 'rush hour' lasts all day and finding parking is a sport.\nTERMINATE"
    )
