...
- [MCP Proxy for Multiagent one MCP Server](https://github.com/ag2ai/ag2/blob/main/notebook/mcp/mcp_proxy_multiagent_one_mcp_server.ipynb)
...
- [MCP Proxy for Multiagent multiple MCP Server](https://github.com/ag2ai/ag2/blob/main/notebook/mcp/mcp_proxy_multiagent_multiple_mcp_server.ipynb)
